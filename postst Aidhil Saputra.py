...
def admin_ubah_menu_seafood():
    ...
    while True:
        ...
        if tindakan_admin == "1":
            ...
            tampilkan_menu_seafood()
            kode_produk_hapus = input("Masukkan kode produk yang ingin dihapus: ")
            if kode_produk_hapus in menu_seafood:
                nama_menu_hapus = menu_seafood[kode_produk_hapus]['nama']
                del menu_seafood[kode_produk_hapus]
                print(f"Produk seafood {nama_menu_hapus} telah dihapus dari menu.")
            else:
                print("Kode produk tidak valid.")
        elif tindakan_admin == "4":
            break
